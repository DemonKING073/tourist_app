          ...
          children: [
            ...
            SizedBox(
              ...
              child: FutureBuilder<String?>(
                future: RecommendedService()
                    .getPlaceIdByPlaceName(data['placeName']),
                builder: (context, placeIdSnapshot) {
                  if (placeIdSnapshot.connectionState ==
                      ConnectionState.waiting) {
                    return Center(
                      child: CircularProgressIndicator(),
                    );
                  } else if (placeIdSnapshot.hasError ||
                      placeIdSnapshot.data == null) {
                    print('Error loading place ID: ${placeIdSnapshot.error}');
                    return Center(
                      child: Text('Error Loading data: Place ID is null'),
                    );
                  } else {
                    final placeId = placeIdSnapshot.data!;
                    return FutureBuilder<QuerySnapshot>(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                          ...
                          print('Error loading hotel data: ${snapshot.error}');
                          return Center(
                            child:
